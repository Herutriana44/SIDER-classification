...
# We use binary:logistic for multi-label binary classification
...
multi_output_xgb = MultiOutputClassifier(estimator=base_xgb)
...
print("Starting GridSearchCV for Multi-label XGBoost...")
grid_search.fit(X_train, y_train)
print("GridSearchCV complete.")

# Best estimator and evaluation
best_multi_output_xgb = grid_search.best_estimator_
y_pred = best_multi_output_xgb.predict(X_test)
...
output_filename = os.path.join(results_folder, "XGBoost_experiment_results.json")
