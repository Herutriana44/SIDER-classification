...
# Load data
df = pd.read_csv("sider.csv") # Updated path based on local structure
...
multi_output_rf = MultiOutputClassifier(estimator=base_rf)
...
print("Starting GridSearchCV for Multi-label Random Forest...")
grid_search.fit(X_train, y_train)
print("GridSearchCV complete.")

# Best estimator and evaluation
best_multi_output_rf = grid_search.best_estimator_
y_pred = best_multi_output_rf.predict(X_test)
...
output_filename = os.path.join(results_folder, "RandomForest_experiment_results.json")
